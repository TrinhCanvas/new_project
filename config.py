...
case_test = {
		...
		"kenh14": {
				...
				"step": [
...

					{
						...
						"name_case": "thực hiện click vào bài viết",
						"locator_tag_post": {
								"type": ["XPATH", "SELECTOR"],
					...
					},
					{
						...
						"name_case": "check tag bài viết đã hiển thị bài đúng chưa",
						"locator_verify_tag": {
								"type": ["XPATH", "SELECTOR"],
...

				{
					...
					"name_case": "Truy cập link bài đặc biệt",
				...
				},
				{
					...
					"name_case": "check hiển thị thời gian trong bài đặc biệt",
					"loacator_special": {
								"type": ["XPATH", "SELECTOR"],
...

				{
					...
					"name_case": "kiểm tra thời gian load_pgae",
					"name_time": "end_time_4",
					"time_check": 5,
				},

				{
					...
					"name_case": "kiểm tra load page 10 lần",
				},
		...
		"baochinhphu": {
				...
				"step": [
...

					{
						...
						"name_case": "click nút hiện trường tìm kiếm",
						"locator_find_button": {
								"type": ["XPATH", "SELECTOR"],
					...
					},
					{
						...
						"name_case": "click dừng video sau 2s chạy",
		...
		"phunuvietnam": {
				...
				"step": [
					...
					{
						"name_func": "open_link_check_search",
						"name_case": "truy cập link tìm kiếm",
